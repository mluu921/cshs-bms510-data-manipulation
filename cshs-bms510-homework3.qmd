...
df <- readxl::read_excel('data/emergency.xlsx', sheet = 1) ## part 1 and part 3 dataset
...
df2 <- readxl::read_excel('data/vaccine2.xlsx', sheet = 1) %>% janitor::clean_names() ## part 2 dataset
