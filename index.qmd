...
# Workflow in Statistical Analysis {.title-inverse}
...
# What is 'tidy' data? {.title-inverse}
...
A collection of R packages that are used to faciliate data exploration, visualization, and 'tidying' of your data.
